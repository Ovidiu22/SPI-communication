...
uint8_t getBatterySOC( uint8_t *diagM )
{
	...
	float voltage = ADCValue / 2.03; // *( 5 (VReff) / 1023 (ADC denomination) * 100 (*) (relative SOC calculus, see below) ); factor was experimentally adapted in order to correspond to 100% at 4.15V
